...
4. 在**回调 URL** 中，指定 Alexa Kill 的 **Redirect URLs**。
 ...
 ![Redirect Urls](https://s3.cn-north-1.amazonaws.com.cn/chinalabs/assets/alexa/account-linking/redirect-urls.png)
...
8. 在 **Client ID** 中，指定 Cognito 应用程序客户端的**应用程序客户端 ID**。
 ...
 ![App Client](https://s3.cn-north-1.amazonaws.com.cn/chinalabs/assets/alexa/account-linking/app-client.png)
